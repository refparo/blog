...
#show: chapter(
  "/eighteen/20201101-mountain-climbing/",
...
接受了太阳的热情的照耀，月球以她的魔力将其转化为更温和的冷白色柔光，播撒在了地球那离开了太阳恩泽的黑暗一面。这样的光线不似阳光般振奋，但有着如水般渗入内心的力量。此刻，灰狼的心与月光共振，泪水顿时充满眼眶，胸中有什么将要喷薄而出——
...
#image("mountain-climbing-1.jpg")

#image("mountain-climbing-2.jpg")
