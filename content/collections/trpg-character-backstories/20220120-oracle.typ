...
#show: chapter(
  "/trpg-character-backstories/20220120-oracle/",
  title: "神谕",
  published: date("2022-01-20"),
  updated: date("2022-01-24"),
  excerpt: [半精灵牧位者伊尼戈·洛约尔的起源故事。（Pathfinder 角色卡）],
)

#quote(block: true)[
  本文为一张 Pathfinder 人物卡的背景故事。

  下面是两个版本，分别信仰两位神灵。信仰莎琳的版本（#link(<永恒蔷薇>)[永恒蔷薇]）由于模组剧情需要被 DM 要求修改，所以不得不写了信仰黑蝴蝶的版本（#link(<静默之间>)[静默之间]）。
]
