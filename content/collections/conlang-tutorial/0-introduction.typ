#import "@project/templates:0.0.0": alias, chapter, date
#alias("/conlang-tutorial/introduction/", "/conlang-tutorial/0-introduction/")
#show: chapter(
  "/conlang-tutorial/0-introduction/",
  title: "引言",
...
一方面，*人造语言，首先是语言*。根据维基百科，_一门语言就是一个结构化的交流系统_#footnote[引自英文维基百科“#link("https://en.wikipedia.org/wiki/Language")[Language]”。]。*交流*是它的功能，而*结构化*是它的特点。结构化的意思是，语言有内部结构，而不是毫无规律。正因如此，我们才能分析它、研究它。*语言学*（linguistics）就是专门研究语言的学科。我们对语言的定义并不限制语言的载体，语音、手势、文字、盲文都可以承载语言，甚至还有其它可能的载体。

另一方面，*人造语言是人为设计的*。有人可能会说，“语言都是人造的，所以人造语言的概念没有意义”。但是，自然语言的所谓的“人造”实际上是说，早期人类在沟通的实践过程中逐渐形成了语言。这种意义上的创造并不需要对语言的存在和语言的内部结构有明确的认识。#footnote[不过，现代国家的政府常常会人为地规范语言。在这个意义上，现代的自然语言也可以说有一定的人造成分。]相比之下，人造语言中的“人造”指的则是：_它，尤其是它的结构，是人有意识地设计的_。这就引出了我们的下一个问题——
...
内容范围广，就会导致对于每个读者来说，我写到的内容并不是全都用得上。因此，本书的内容并不需要从头到尾一字不落地读，这就要请你_联系自己创造语言的目标，挑选需要的部分阅读_，其他部分只要浏览即可。本书的每一章开头都会有导言，介绍这一章会讲到什么，每一节开头还会列举这一节的所有要点，你可以借助它们判断哪些部分对自己来说更重要。

既循序渐进又广泛涉猎，就意味着每一方面没法讲得非常深入。读到特别感兴趣的地方，你_不应该止于本书提供的信息，而应该自己查阅更专业的资料_。本书的每一节最后都会提供扩展阅读书目。除此之外，善用搜索引擎、学会查阅维基百科、阅读外语资料也是成为一个优秀造语人必备的技能。下面再列举一些优质的语言学和造语信息来源：

- 语言学资料网站，如 #link("https://wals.info/")[WALS]、#link("https://glottolog.org/")[Glottolog]、#link("https://www.omniglot.com/")[Omniglot]；
- 人造语言社区，如 #link("https://conworkshop.com/")[ConWorkShop]、#link("https://www.reddit.com/r/conlangs/")[r/conlangs]；
