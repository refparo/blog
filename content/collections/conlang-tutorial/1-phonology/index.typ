#import "@project/templates:0.0.0": chapter, date, ruby
#show: chapter(
  "/conlang-tutorial/1-phonology/",
  title: "第一章：音系",
...
笑话中，日本人把 supplies 听成了 surprise，就是因为虽然这两个词的读音不同，在英语里意义不同，但日语却不能区分这两个词的发音，把它们都当成“#ruby(lang: "ja")[サプライズ][sapuraizu]”。这也告诉我们，同一组声音可能在一门语言中区分意义，在另一门语言中却不区分。
