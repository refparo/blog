...
#show: post(
  "/20190908-higher-kinded-types-in-typescript/",
  title: "在 TypeScript 中模拟高阶类型",
  tags: "编程语言",
  published: date("2019-09-08"),
  outline: true,
  excerpt: [TypeScript 虽然没那么强，但又很强。],
)

*高阶类型*（_Higher Kinded Types_）对我这个 PL 爱好者来说，几乎是必备的语言特性了。Typescript 是我主要使用的语言之一，它虽然不直接支持高阶类型，但利用它本身已经比较强大的类型系统，是可以模拟出高阶类型的。
...
本文的实现思路来源于 #link("https://github.com/strax/tshkt")[strax/tshkt]。
